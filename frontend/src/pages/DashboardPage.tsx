        ...
        <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="bg-bg-card border border-border rounded-xl p-6">
              <h3 className="text-text-primary font-medium mb-6 text-center">{t('dashboard.pillar_scores')}</h3>
              <div className="flex justify-center gap-8">
                <ScoreGauge score={result.fundamental_score} label={t('tab.fundamental')} />
                <ScoreGauge score={result.technical_score} label={t('tab.technical')} />
                <ScoreGauge score={result.sentiment_score} label={t('tab.sentiment')} />
              </div>
            </div>
            <div className="bg-bg-card border border-border rounded-xl p-6">
              <h3 className="text-text-primary font-medium mb-4 text-center">{t('dashboard.radar_title')}</h3>
              <RadarChart
          ...
          {/* AI Dashboard — Action Checklist + News Digest */}
